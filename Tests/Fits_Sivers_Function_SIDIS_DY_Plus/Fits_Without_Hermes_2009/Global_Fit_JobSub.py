...
m.limits=((24.7,30.7),(2.5,3.34),(2.26,3.22),(13.2,22),(-.25,0.07),(-4.9,-1.7),(.8,2.8),(3,19),(-1.7,2.3),(13,17),(3.17,3.73),(20.4,33.2),(-3.9,6.1))
    
m.migrad()

f = open("Global_Fit_Sivers_SIDIS_DY_Plus_Without_H09_v2_3.txt","w")
for i in range(1):
...
with open("Global_Fit_Sivers_SIDIS_DY_Parameters_Plus_Without_H09_v2_3.txt", "w") as f2:
