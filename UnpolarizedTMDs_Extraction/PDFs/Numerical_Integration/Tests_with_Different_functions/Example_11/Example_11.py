...
plt.plot(x2vals, true_values_3, label='True nnubar v2', linestyle='--')
plt.plot(x2vals, predicted_values_2, label='Predicted nnubar')
plt.plot(x2vals, predicted_values_3, label='Predicted nnubar v2')
