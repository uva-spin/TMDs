...
#     # k_values = tf.linspace(0.0, 0.0, 100)
...
def createModel_DY():
    ...
    tmd1_list.append(nnu_x1)
    tmd2_list.append(nnubar_x2)
    product_list=tf.multiply(nnu_x1, nnubar_x2)
...
# loss_weights = { 'tf.math.multiply_405': 1.0, "nnu": 0.00001, "nnu_1": 0.00001}
# loss_weights = { 'tf.math.multiply_405': 1.0, "nnu": 1.0, "nnu_1": 1.0}
