...
Hidden_Layers = 5  # Reduced for simplicity
Nodes_per_HL = 200  # Reduced for simplicity
...
#         tf.keras.layers.Input(shape=(2,)),  # Two inputs: k and QM
#         tf.keras.layers.Dense(200, activation='relu6'),
#         tf.keras.layers.Dense(200, activation='relu6'),
#         tf.keras.layers.Dense(200, activation='relu6'),
#         tf.keras.layers.Dense(200, activation='relu6'),
#         tf.keras.layers.Dense(1, activation='exponential', name=name)  # Output S(k, QM)
#     ])
#     return model
