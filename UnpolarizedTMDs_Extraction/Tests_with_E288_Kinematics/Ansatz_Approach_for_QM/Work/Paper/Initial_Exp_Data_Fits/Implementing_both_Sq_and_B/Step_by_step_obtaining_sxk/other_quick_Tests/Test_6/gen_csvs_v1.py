...
def main():
    ...
    for i, model in enumerate(models):
        ...
        n1_outputs_each_k = np.array(n1_outputs_each_k)
        n1_pred_for_x1.append(n1_outputs_each_k)
    n1_pred_for_x1 = np.array(n1_pred_for_x1)

    # Calculate mean and standard deviation across all models
    n1_mean = np.mean(n1_pred_for_x1, axis=0)
    n1_std = np.std(n1_pred_for_x1, axis=0)
    ...
    SqT_df.to_csv('comparison_plots/SqT_results.csv', index=False)
