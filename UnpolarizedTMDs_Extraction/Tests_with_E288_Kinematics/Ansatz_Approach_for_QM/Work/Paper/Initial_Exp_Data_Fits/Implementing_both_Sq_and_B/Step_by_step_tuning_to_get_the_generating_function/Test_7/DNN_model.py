...
def DNNS(name):
    ...
    for i in range(4):
        x = tf.keras.layers.Dense(200, activation='relu', kernel_initializer = initializer, kernel_regularizer=tf.keras.regularizers.L1(L1_reg), activity_regularizer=tf.keras.regularizers.L1(L1_reg))(x)
