...
# Load Data
E288_200 = pd.read_csv("Temp_Data/E288_200.csv")
E288_400 = pd.read_csv("Temp_Data/E288_400.csv")


data = pd.concat([E288_200,E288_400], ignore_index=True)
...
def GenerateReplicaData(df):
    ...
    # Compute PDFs
    f_u_x1 = (1/x1_values)*pdf(NNPDF4_nlo, 2, x1_values, QM_values)
    f_ubar_x2 = (1/x2_values)*pdf(NNPDF4_nlo, -2, x2_values, QM_values)
    f_u_x2 = (1/x2_values)*pdf(NNPDF4_nlo, 2, x2_values, QM_values)
    f_ubar_x1 = (1/x1_values)*pdf(NNPDF4_nlo, -2, x1_values, QM_values)
    f_d_x1 = (1/x1_values)*pdf(NNPDF4_nlo, 1, x1_values, QM_values)
    f_dbar_x2 = (1/x2_values)*pdf(NNPDF4_nlo, -1, x2_values, QM_values)
    f_d_x2 = (1/x2_values)*pdf(NNPDF4_nlo, 1, x2_values, QM_values)
    f_dbar_x1 = (1/x1_values)*pdf(NNPDF4_nlo, -1, x1_values, QM_values)
    f_s_x1 = (1/x1_values)*pdf(NNPDF4_nlo, 3, x1_values, QM_values)
    f_sbar_x2 = (1/x2_values)*pdf(NNPDF4_nlo, -3, x2_values, QM_values)
    f_s_x2 = (1/x2_values)*pdf(NNPDF4_nlo, 3, x2_values, QM_values)
    f_sbar_x1 = (1/x1_values)*pdf(NNPDF4_nlo, -3, x1_values, QM_values)
    ...
    SB = ReplicaA *SqrtS * SqrtS / (hc_factor * factor * PDFs * QM_integral)
...
def compute_A(model, x1, x2, qT, QM, SqrtS):
    ...
    A_pred = SB_DNN_mean * factor_temp * PDFs_temp * hc_factor * QM_integral_temp /(SqrtS*SqrtS)
    return A_pred
...
def prep_data_for_plots(model,df):
    ...
    A_pred = compute_A(model, x1, x2, qT, QM, SqrtS)
...
def replica_model(i):
    ...
    replica_data = pd.concat([E288_200_Replica,E288_400_Replica], ignore_index=True)
