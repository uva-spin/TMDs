...
def replica_model(i):
    ...
    # pdf_x1x2_train = precompute_pdf_values_x1x2(x1_train.flatten(), x2_train.flatten(), QM_train.flatten())
    # pdf_x2x1_train = precompute_pdf_values_x2x1(x2_train.flatten(), x1_train.flatten(), QM_train.flatten())

    # pdf_x1x2_test = precompute_pdf_values_x1x2(x1_test.flatten(), x2_test.flatten(), QM_test.flatten())
    # pdf_x2x1_test = precompute_pdf_values_x2x1(x2_test.flatten(), x1_test.flatten(), QM_test.flatten())


    # # Train model with the additional PDF input
