...
def compute_A(x1, x2, qT, QM, SqrtS):
    ...
    A_pred = fDNN_mean * factor_temp * PDFs_temp * hc_factor * QM_integral_temp /(SqrtS*SqrtS)
    A_std = fDNN_std * factor_temp * PDFs_temp * hc_factor * QM_integral_temp /(SqrtS*SqrtS)
