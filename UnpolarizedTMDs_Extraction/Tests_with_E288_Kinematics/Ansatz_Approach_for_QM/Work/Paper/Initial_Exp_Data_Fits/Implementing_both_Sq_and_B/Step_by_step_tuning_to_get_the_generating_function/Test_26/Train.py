...
def GenerateReplicaData_from_Selected_Kinematics(df):
    df=df[df['qT'] < 0.2 * df['QM']]
    df = df[(9.0 > df['QM']) | (df['QM'] > 11.0)]
    df = df[(df['QM']==4.5) | (df['QM']==5.5) | (df['QM']==6.5) | (df['QM']==7.5)]
    pseudodata_df = {'x1': [],
                     'x2': [],
                     'qT': [],
                     'QM': [],
...
def replica_model(i):
    ...
    #################
    E288_200_AUX_1 = GenerateReplicaData_from_Selected_Kinematics(E288_200)
    E288_200_AUX_2 = GenerateReplicaData_from_Selected_Kinematics(E288_200)
    E288_200_AUX_3 = GenerateReplicaData_from_Selected_Kinematics(E288_200)
    E288_200_AUX_4 = GenerateReplicaData_from_Selected_Kinematics(E288_200)
    E288_200_AUX_5 = GenerateReplicaData_from_Selected_Kinematics(E288_200)

    E288_400_AUX_1 = GenerateReplicaData_from_Selected_Kinematics(E288_400)
    E288_400_AUX_2 = GenerateReplicaData_from_Selected_Kinematics(E288_400)
    E288_400_AUX_3 = GenerateReplicaData_from_Selected_Kinematics(E288_400)
    E288_400_AUX_4 = GenerateReplicaData_from_Selected_Kinematics(E288_400)
    E288_400_AUX_5 = GenerateReplicaData_from_Selected_Kinematics(E288_400)


    # replica_data = GenerateReplicaData(data)
    E288_200_aux = pd.concat([E288_200_AUX_1,E288_200_AUX_2,E288_200_AUX_3,E288_200_AUX_4,E288_200_AUX_5])
    E288_400_aux = pd.concat([E288_400_AUX_1,E288_400_AUX_2,E288_400_AUX_3,E288_400_AUX_4,E288_400_AUX_5])
    replica_data = pd.concat([E288_200_Replica,E288_300_Replica,E288_400_Replica,E288_200_aux,E288_400_aux], ignore_index=True)
