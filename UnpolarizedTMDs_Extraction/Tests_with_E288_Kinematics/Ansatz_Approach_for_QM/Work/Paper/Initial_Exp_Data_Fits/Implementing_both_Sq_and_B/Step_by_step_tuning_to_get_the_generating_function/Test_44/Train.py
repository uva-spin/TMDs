...
E288_200 = add_weight_column(E288_200_initial, 500, 7.0, 'n')
E288_300 = add_weight_column(E288_300_initial, 1, 4.0, 'n')
E288_400 = add_weight_column(E288_400_initial, 500, 7.7, 'n')
...
def GenerateReplicaData(df):
    ...
    SB = ReplicaA / (hc_factor * factor * PDFs * QM_integral * SqrtS)
...
def compute_A(model, x1, x2, qT, QM, SqrtS):
    ...
    A_pred = SB_DNN_mean * factor_temp * PDFs_temp * hc_factor * QM_integral_temp * SqrtS
    return A_pred
