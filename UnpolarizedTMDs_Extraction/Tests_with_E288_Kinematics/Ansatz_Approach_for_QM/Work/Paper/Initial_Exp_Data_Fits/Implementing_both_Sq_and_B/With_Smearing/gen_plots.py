...
# Compute B(QM)
SB_true = A_true_values / (hc_factor * factor * PDFs * QM_integral)
...
dnnQ_contributions = np.array([model.predict([qT_values,QM_values], verbose=0).flatten() for model in models_list])
