...
# models_folder = '/scratch/cee9hc/Unpolarized_TMDs/with_E288_E605/Cross_Sections_Fits_Test_01/Models'
...
E605_result_df = prep_data_for_plots(E605)
E605_result_df.to_csv(f'{results_folder}/E605_results.csv')
...
E288_200_with_cuts = E288_200_with_cuts[(E288_200_with_cuts['QM'] <= 9.0) | (E288_200_with_cuts['QM'] >= 11.0)]
...
E288_300_with_cuts = E288_300_with_cuts[(E288_300_with_cuts['QM'] <= 9.0) | (E288_300_with_cuts['QM'] >= 11.0)]
...
E288_400_with_cuts = E288_400_with_cuts[(E288_400_with_cuts['QM'] <= 9.0) | (E288_400_with_cuts['QM'] >= 11.0)]
E288_400_with_cuts.to_csv(f'{results_folder}/E288_400_results_with_cuts.csv')

E605_with_cuts = E605_result_df
#E605_with_cuts=E605_result_df[E605_result_df['qT'] < 0.2 * E605_result_df['QM']]
# E605_with_cuts = E605_with_cuts[(9.0 > E605_with_cuts['QM']) | (E605_with_cuts['QM'] > 11.0)]
E605_with_cuts = E605_with_cuts[(E605_with_cuts['QM'] <= 9.0) | (E605_with_cuts['QM'] >= 11.0)]
E605_with_cuts.to_csv(f'{results_folder}/E605_results_with_cuts.csv')
...
PDFs_x1x2_array = np.array(PDFs_x1x2_reshaped)
PDFs_x2x1_array = np.array(PDFs_x2x1_reshaped)
PDFs = PDFs_x1x2_array + PDFs_x1x2_array
...
temp_df['PDFs_x1x2'] = PDFs_x1x2_array.flatten()
temp_df['PDFs_x2x1'] = PDFs_x2x1_array.flatten()
temp_df['PDFs'] = PDFs.flatten()

# print(QM_values)
# print((PDFs_x1x2_array).flatten())

# print(len(QM_values))
# print(len(PDFs_x1x2_array))
