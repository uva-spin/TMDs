...
ux1ubarx2_term = eu2*np.array(f_u_x1)*np.array(f_ubar_x2)
ubarx1ux2_term = eu2*np.array(f_u_x2)*np.array(f_ubar_x1)
dx1dbarx2_term = ed2*np.array(f_d_x1)*np.array(f_dbar_x2)
dbarx1dx2_term = ed2*np.array(f_d_x2)*np.array(f_dbar_x1)
sx1sbarx2_term = es2*np.array(f_s_x1)*np.array(f_sbar_x2)
sbarx1sx2_term = es2*np.array(f_s_x2)*np.array(f_sbar_x1)
