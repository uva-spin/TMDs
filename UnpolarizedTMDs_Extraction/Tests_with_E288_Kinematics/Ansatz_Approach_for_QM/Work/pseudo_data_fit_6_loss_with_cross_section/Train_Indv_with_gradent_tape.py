...
def replica_model(i):
    ...
    for epoch in range(epochs):
        ...
        for i in range(0, len(QM_values), batch_size):
            batch_indices = indices[i:min(i + batch_size, len(QM_values))]
    ...
    # Create a history-like object for compatibility with your plotting code
    class History:
    ...
    generate_subplots(dnnB, replica_data, i)
        ...
        # plt.plot(loss_history.history['loss'], label='Loss', color='b')
