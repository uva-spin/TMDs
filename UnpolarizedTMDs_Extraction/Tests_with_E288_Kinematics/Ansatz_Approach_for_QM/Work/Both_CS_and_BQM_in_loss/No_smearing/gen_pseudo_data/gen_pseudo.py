...
E605 = pd.read_csv("../../Data_Test/E605.csv")
E772 = pd.read_csv("../../Data_Test/E772.csv")
...
E288_200_pseudo.to_csv("pseudodata_E288_200.csv", index=False)

E228_300_pseudo = gen_pseudo(E288_300)
E228_300_pseudo.to_csv("pseudodata_E288_300.csv", index=False)

E228_400_pseudo = gen_pseudo(E288_400)
E228_400_pseudo.to_csv("pseudodata_E288_400.csv", index=False)

E605_pseudo = gen_pseudo(E605)
E605_pseudo.to_csv("pseudodata_E605.csv", index=False)

E772_pseudo = gen_pseudo(E772)
E772_pseudo.to_csv("pseudodata_E772.csv", index=False)
