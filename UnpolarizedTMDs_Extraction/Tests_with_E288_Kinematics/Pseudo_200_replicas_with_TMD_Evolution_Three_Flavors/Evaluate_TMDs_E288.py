...
def Generate_Comparison_Plots(df, num_replicas, output_name):
    ...
    true_values_d = fu_xA * Sku(Kvals,QMvals)  
    true_values_dbar = fubar_xB * Skubar(pT_k_vals,QMvals) 
    true_values_s = fu_xA * Sku(Kvals,QMvals)  
    true_values_sbar = fubar_xB * Skubar(pT_k_vals,QMvals) 
    ...
    plt.plot(x1vals, true_values_u, label='True nnu', linestyle='--')
    ...
    plt.plot(x2vals, true_values_ubar, label='True nnubar', linestyle='--')
    ...
    plt.plot(x1vals, true_values_d, label='True nnd', linestyle='--')
    ...
    plt.plot(x2vals, true_values_dbar, label='True nndbar', linestyle='--')
    ...
    plt.plot(x1vals, true_values_s, label='True nns', linestyle='--')
    ...
    plt.plot(x2vals, true_values_sbar, label='True nnsbar', linestyle='--')
