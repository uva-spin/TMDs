...
def Skq(k,Q):
    return np.exp(-4*k**2/(4*k**2 + 4))*np.log(100/Q)

def Skqbar(k,Q):
    return np.exp(-4*k**2/(4*k**2 + 1))*np.log(100/Q)
...
def Generate_Comparison_Plots(df, num_replicas, output_name):
    ...
    true_values_1 = fu_xA * Skq(Kvals,QMvals)  
    true_values_2 = fubar_xB * Skqbar(pT_k_vals,QMvals) 
...
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_1')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_2')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_3')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_4')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_5')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_6')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_7')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_8')
#Generate_Comparison_Plots(pdfs0,numreplicas,'set_9')
