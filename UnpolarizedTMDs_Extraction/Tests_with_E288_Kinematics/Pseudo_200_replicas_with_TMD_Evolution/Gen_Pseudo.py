...
def fx1kx2k(xA,xB,pT,k,QM):
    return fq_val(xA,xAvals,fu_xA)*Skq(k,QM)*fqbar_val(xB,xBvals,fubar_xB)*Skqbar(pT-k,QM) + fqbar_val(xA,xAvals,fubar_xA)*Skqbar(k,QM)*fq_val(xB,xBvals,fu_xB)*Skq(pT-k,QM)
