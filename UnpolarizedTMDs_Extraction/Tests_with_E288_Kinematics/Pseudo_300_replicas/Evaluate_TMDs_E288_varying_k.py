...
def Generate_Comparison_Plots_for_Kvalue(df, num_replicas, kvalue, output_name):
    ...
    # plt.grid(True)
    # #plt.show()
    # plt.savefig('Evaluations_TMDs_with_kval/True_Pred_fx_q_'+str(output_name)+'.pdf')
    # plt.close()
    ...
    # plt.grid(True)
    # #plt.show()
    # plt.savefig('Evaluations_TMDs_with_kval/True_Pred_fx_qbar_'+str(output_name)+'.pdf')
    # plt.close()
    ...
    # plt.grid(True)
    # #plt.show()
    # plt.savefig('Evaluations_TMDs_with_kval/True_Pred_fx_q_rev_'+str(output_name)+'.pdf')
    # plt.close()
    ...
    # plt.grid(True)
    # #plt.show()
    # plt.savefig('Evaluations_TMDs_with_kval/True_Pred_fx_qbar_rev_'+str(output_name)+'.pdf')
    # plt.close()
