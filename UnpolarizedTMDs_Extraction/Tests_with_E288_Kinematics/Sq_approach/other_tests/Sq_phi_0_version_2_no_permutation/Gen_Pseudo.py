...
def sigma(xA, xB, pT, QM):
    ...
    temp_k = np.linspace(k_lower, k_upper, 500)
    temp_integrand_k = []
    ...
    integral = mult*pT*xA*xB*simpson(temp_integrand_k, dx=temp_k[1]-temp_k[0])
    return integral
...
def Apseudo(x1,x2,pT,QM):
    ...
    print('Generating pseusdo-data has been completed!')
