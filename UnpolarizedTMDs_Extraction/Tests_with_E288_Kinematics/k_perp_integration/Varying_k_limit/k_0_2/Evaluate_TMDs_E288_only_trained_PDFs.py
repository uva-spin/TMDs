...
def Generate_Comparison_Plots(df, num_replicas, output_name):
    ...
    Kvals = np.linspace(0,2,len(x1vals))
    ...
    for i in range(num_replicas):
        ...
        for j in range(0,len(x1vals)):
            ...
            temp_fubar_xB = Generate_PDFs(modnnubar,tempxB,tempQM)
            tempfubarxA.append(temp_fubar_xB)
        #######################################
        predfuxA.append(list(tempfuxA))
        predfubarxB.append(list(temp_fubar_xB))
        predfuxB.append(list(temp_fu_xB))
        predfubarxA.append(list(tempfubarxA))
    ###########################################
