...
Generate_Comparison_Plots_for_Kvalue(pdfs0,numreplicas, 10, 'set_0_k=10')
Generate_Comparison_Plots_for_Kvalue(pdfs0,numreplicas, 20, 'set_0_k=20')
Generate_Comparison_Plots_for_Kvalue(pdfs0,numreplicas, 30, 'set_0_k=30')
Generate_Comparison_Plots_for_Kvalue(pdfs0,numreplicas, 50, 'set_0_k=50')
