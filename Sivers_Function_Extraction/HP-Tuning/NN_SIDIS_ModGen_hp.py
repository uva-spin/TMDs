...
save_path = '/scratch/cee9hc/Sivers_NN_Models/Train_Real/DSSTestFits/NNFitCalcGridPseudo-HP/rep'
...
#Org_Data_path = 'PseudoData_LHAPDF/'
...
def create_nn_model(name, hidden_layers=Hidden_Layers, activation='relu6'):
