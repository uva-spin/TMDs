...
def fqp(x, QQ, kperp2avg, kperp, flavor):
    ...
    '''
    had = functions_develop.SIDIS_Hadron()
...
#################################################################################
############################## From Pseudo-data or Minuit Fits ##################
#################################################################################
...
plt.figure(1)    
plotSivDistBands(19, 0.1, 2.4, .57, np.array(list(range(150)))/100)
plt.figure(2)
plotSivDistBandsSea(19, 0.1, 2.4, .57, np.array(list(range(150)))/100)