...
def customfit(model1, model2, epchs, X1, y1, sample_weights1, X2, y2, sample_weights2, loss_fn, optimizer, batch_size):
    #epochs = 2
...
def trainReplicas_new(epochs, X1, y1, err1, X2, y2, err2, loss_fn, optimizer, numReplicas, batch_size):
    for i in range(numReplicas):
