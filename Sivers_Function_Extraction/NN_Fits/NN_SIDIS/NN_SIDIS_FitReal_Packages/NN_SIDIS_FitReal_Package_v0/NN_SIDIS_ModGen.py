...
save_path = '/scratch/cee9hc/Sivers_NN_Models/Train_Real/Models_SIDIS_fullUn_v1/rep'
Org_Data_path = 'Data/'
...
def run_replica():
    ...
    df["Siv_Rep"] = np.random.normal(df["Siv"].to_numpy(), np.absolute(df["tot_err"].to_numpy()))
    dataSIDIS = DataSIDIS()
