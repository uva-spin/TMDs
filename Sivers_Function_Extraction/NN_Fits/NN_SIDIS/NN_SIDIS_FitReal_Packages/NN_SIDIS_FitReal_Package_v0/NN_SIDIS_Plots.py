...
Models_Folder = '/scratch/cee9hc/Sivers_NN_Models/Train_Real/Models_SIDIS_fullUn_v1'
...
f1 = plt.figure(1)
plotSivDistBands(NNModels, 0.1, 2.4, .57, -2, np.array(list(range(150)))/100)
f2 = plt.figure(2)
plotSivDistBandsSea(NNModels, 0.1, 2.4, .57, -2, np.array(list(range(150)))/100)