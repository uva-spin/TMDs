...
Models_Folder = '/scratch/cee9hc/Sivers_NN_Models/Train_Real/Models_SIDIS_v4'
...
def plotSivDistBands(numReplicas, x, QQ, kperp2avg, kperp, numSigma=1):
    ...
    plt.savefig('SiversQ_SIDIS_NN_RealD.pdf', format='pdf', bbox_inches='tight')
...
def plotSivDistBandsSea(numReplicas, x, QQ, kperp2avg, kperp, numSigma=1):
    ...
    plt.savefig('SiversAntiQ_SIDIS_NN_RealD.pdf', format='pdf', bbox_inches='tight')     
