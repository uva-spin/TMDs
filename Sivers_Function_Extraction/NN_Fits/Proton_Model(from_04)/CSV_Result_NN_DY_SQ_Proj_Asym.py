...
SQ_DY_DATA = pd.read_csv('../Data/SpinQuest.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
...
# NN_SQ_DY_from_SIDIS_plus=Project_COMPASS_DY(SQ_DY_DATA, numreplicas_SIDIS, 1)
# NN_SQ_DY_from_SIDIS_plus.to_csv(str(OutputFolder)+'/Result_SpinQuest_DY_from_SIDIS_plus.csv')

NN_SQ_DY_from_SIDIS_minus=Project_COMPASS_DY(SQ_DY_DATA, numreplicas_SIDIS,-1)
NN_SQ_DY_from_SIDIS_minus.to_csv(str(OutputFolder)+'/Result_SpinQuest_DY_from_SIDIS_minus.csv')
