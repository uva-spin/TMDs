...
def density_func(model, x, QQ, kperp2avg, flavor, kxx, kyy):
    ...
    return (1/x)*(fqp(x, QQ, kperp2avg, kTval, flavor) + (0.5)*(kxx/kTval)*xSivFunction(model, x, QQ, kperp2avg, flavor, kTval))
...
dftD.to_csv("threeD_plot_data_test.csv", index=False)
