...
def Pseudo_Sivers_Q_Plots(x, n, a, b, m1, QQ, kperp2avg, kperp):
    kp = kperp
    SivU=Pseudo_SiversQ(x, n, a, b, m1, QQ, kperp2avg, kperp, 2)
    plt.plot(kperp, SivU,'--', color='lightblue', label='$u_{true}$')
    SivD=Pseudo_SiversQ(x, n, a, b, m1, QQ, kperp2avg, kperp, 1)
    plt.plot(kperp, SivD,'--', color='tomato', label='$d_{true}$')
    SivS=Pseudo_SiversQ(x, n, a, b, m1, QQ, kperp2avg, kperp, 3)
    plt.plot(kperp, SivS,'--', color='lightgreen', label='$s_{true}$')

def Pseudo_Sivers_AntiQ_Plots(x, n, a, b, m1, QQ, kperp2avg, kperp):
    kp = kperp
    SivU=Pseudo_SiversAntiQ(x, n, a, b, m1, QQ, kperp2avg, kperp, 2)
    plt.plot(kperp, SivU,'--', color='lightblue', label='$\\bar{u}_{true}$')
    SivD=Pseudo_SiversAntiQ(x, n, a, b, m1, QQ, kperp2avg, kperp, 1)
    plt.plot(kperp, SivD,'--', color='tomato', label='$\\bar{d}_{true}$')
    SivS=Pseudo_SiversAntiQ(x, n, a, b, m1, QQ, kperp2avg, kperp, 3)
    plt.plot(kperp, SivS,'--', color='lightgreen', label='$\\bar{s}_{true}$')
    

    
    
def plotSivDistBands(numReplicas, x, QQ, kperp2avg, kperp, numSigma=2):
    ...
    Pseudo_Sivers_Q_Plots(0.1, 1, 1, 1, 1, 2.4,  .57,  np.array(list(range(150)))/100)
...
def plotSivDistBandsSea(numReplicas, x, QQ, kperp2avg, kperp, numSigma=2):
    #datann = DataANN()
    ...
    Pseudo_Sivers_AntiQ_Plots(0.1, 1, 1, 1, 1, 2.4,  .57,  np.array(list(range(150)))/100)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=20)
...
plotSivDistBands(2, 0.1, 2.4, .57, np.array(list(range(150)))/100)
plotSivDistBandsSea(2, 0.1, 2.4, .57, np.array(list(range(150)))/100)