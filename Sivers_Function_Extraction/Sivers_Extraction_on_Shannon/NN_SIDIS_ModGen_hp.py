...
save_path = '/project/UVA-Spin/Ishara/Sivers/PseudoDataNNFit_300rep_LR_0000110/Models/rep'
...
HERMES2009 = 'HERMES2009_Pseudo.csv'
HERMES2020 = 'HERMES2020_Pseudo.csv'
COMPASS2009 = 'COMPASS2009_Pseudo.csv'
COMPASS2015 = 'COMPASS2015_Pseudo.csv'


SIDIS_Repl_Folder = '/project/UVA-Spin/Ishara/Sivers/PseudoDataNNFit_300rep_LR_0000110/Replica_Data'
Losses_Folder = '/project/UVA-Spin/Ishara/Sivers/PseudoDataNNFit_300rep_LR_0000110/loss'
...
#comp15_gen.to_csv('COMPASS2019_test.csv')

# torg = np.array(comp15['Siv'])
# trep = np.array(comp15_gen['Siv'])
# tdiff = np.abs(torg-trep)
# terr = np.array(comp15['tot_err'])
# print(tdiff/terr)
...
def run_replica():
    ...
    tempdf = pd.concat([herm09_gen, comp09_gen, comp15_gen])
    ...
    history = sivModel.fit(trn_X, trn_y, validation_data=(tst_X, tst_y), epochs=EPOCHS, callbacks=[modify_LR], batch_size=256, verbose=2)
    ...
    tempdfF["Train_Loss"] = history.history['loss'][-100:]
    tempdfF["Val_Loss"] = history.history['val_loss'][-100:]
