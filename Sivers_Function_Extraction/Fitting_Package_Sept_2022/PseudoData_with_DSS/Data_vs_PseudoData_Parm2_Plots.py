...
herm9 = pd.read_csv('./PseudoData_Parm2/HERMES2009_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
herm20 = pd.read_csv('./PseudoData_Parm2/HERMES2020_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
comp9 = pd.read_csv('./PseudoData_Parm2/COMPASS2009_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
comp15 = pd.read_csv('./PseudoData_Parm2/COMPASS2015_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
