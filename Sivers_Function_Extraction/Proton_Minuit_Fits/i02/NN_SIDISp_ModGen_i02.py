...
def run_replica():
    ...
    tempdf = pd.concat([herm20_gen, comp15_gen])
    ...
    #history = sivModel.fit(trn_X, trn_y, validation_data=(tst_X, tst_y), epochs=EPOCHS, callbacks=[modify_LR], batch_size=300, verbose=2)
    ...
    #tempdfF["Train_Loss"] = history.history['loss'][-2000:]
    #tempdfF["Val_Loss"] = history.history['val_loss'][-2000:]
