...
def plotSivDistBands(numReplicas, x, QQ, kperp2avg, kperp, numSigma=2):
    ...
    plt.savefig('SiversQ_SIDIS_NN_Set_3.pdf', format='pdf', bbox_inches='tight')
...
def plotSivDistBandsSea(numReplicas, x, QQ, kperp2avg, kperp, numSigma=2):
    ...
    plt.savefig('SiversAntiQ_SIDIS_NN_Set_3.pdf', format='pdf', bbox_inches='tight')     
    

plt.figure(1)    
plotSivDistBands(numreplicas_SIDIS, 0.1, 2.4, .57, np.array(list(range(150)))/100)
plt.figure(2)
plotSivDistBandsSea(numreplicas_SIDIS, 0.1, 2.4, .57, np.array(list(range(150)))/100)