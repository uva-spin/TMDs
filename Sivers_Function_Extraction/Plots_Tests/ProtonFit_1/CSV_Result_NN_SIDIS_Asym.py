...
# herm9_DATA = pd.read_csv(str(Org_Data_path)+'HERMES2009_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
# herm20_DATA = pd.read_csv(str(Org_Data_path)+'HERMES2020_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
# comp9_DATA = pd.read_csv(str(Org_Data_path)+'COMPASS2009_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
# comp15_DATA = pd.read_csv(str(Org_Data_path)+'COMPASS2015_Pseudo.csv').dropna(axis=0, how='all').dropna(axis=1, how='all')
