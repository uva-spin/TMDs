...
SIDIS_PDFs_Array=(SIDIS_PDFs_HERMES_p_2009,SIDIS_PDFs_HERMES_p_2020,SIDIS_PDFs_COMPASS_d_2009,SIDIS_PDFs_COMPASS_p_2009)
###########################################################################
#####################  SIDIS FFs #########################################
###########################################################################
...
#     for i in range(0,had_len):
#         if temHads[i]=="pi+":
#             tempfit=Asymmetry_for_Hadron(datfile,"pi+",m1=m1,Nu=Nu,alphau=alphau,betau=betau,Nubar=Nubar,Nd=Nd,alphad=alphad,betad=betad,Ndbar=Ndbar,Ns=Ns,alphas=alphas,betas=betas,Nsbar=Nsbar)
#             fittot.append(tempfit)
#         elif temHads[i]=="pi-":
#             tempfit=Asymmetry_for_Hadron(datfile,"pi-",m1=m1,Nu=Nu,alphau=alphau,betau=betau,Nubar=Nubar,Nd=Nd,alphad=alphad,betad=betad,Ndbar=Ndbar,Ns=Ns,alphas=alphas,betas=betas,Nsbar=Nsbar)
#             fittot.append(tempfit)
#         elif temHads[i]=="pi0":
#             tempfit=Asymmetry_for_Hadron(datfile,"pi0",m1=m1,Nu=Nu,alphau=alphau,betau=betau,Nubar=Nubar,Nd=Nd,alphad=alphad,betad=betad,Ndbar=Ndbar,Ns=Ns,alphas=alphas,betas=betas,Nsbar=Nsbar)
#             fittot.append(tempfit)
#         elif temHads[i]=="k+":
#             tempfit=Asymmetry_for_Hadron(datfile,"k+",m1=m1,Nu=Nu,alphau=alphau,betau=betau,Nubar=Nubar,Nd=Nd,alphad=alphad,betad=betad,Ndbar=Ndbar,Ns=Ns,alphas=alphas,betas=betas,Nsbar=Nsbar)
#             fittot.append(tempfit)
#         elif temHads[i]=="k-":
#             tempfit=Asymmetry_for_Hadron(datfile,"k-",m1=m1,Nu=Nu,alphau=alphau,betau=betau,Nubar=Nubar,Nd=Nd,alphad=alphad,betad=betad,Ndbar=Ndbar,Ns=Ns,alphas=alphas,betas=betas,Nsbar=Nsbar)
#             fittot.append(tempfit)
