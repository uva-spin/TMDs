...
def generate_file(n_array):
    ...
    ms = Minuit(totalchi2Minuit,m1=M1_test,Nu=NU_test,alphau=AlphaU_test,betau=BetaU_test,Nubar=NUbar_test,Nd=ND_test,alphad=AlphaD_test,betad=BetaD_test,Ndbar=NDbar_test,Ns=NS_test,alphas=AlphaS_test,betas=BetaS_test,Nsbar=NSbar_test)
    ms.migrad()
