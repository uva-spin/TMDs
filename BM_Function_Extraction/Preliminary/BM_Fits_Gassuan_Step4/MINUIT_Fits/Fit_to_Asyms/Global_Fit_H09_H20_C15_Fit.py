...
def totalchi2Minuit(m1,Nu,au,bu,Nub,aub,bub,Nd,ad,bd,Ndb,adb,bdb,Ns,aS,bS,Nsb,aSb,bSb):
    tempchi2=SIDIStotalchi2Minuit_R(m1=m1,Nu=Nu,au=au,bu=bu,Nub=Nub,aub=aub,bub=bub,Nd=Nd,ad=ad,bd=bd,
                                  Ndb=Ndb,adb=adb,bdb=bdb,Ns=Ns,aS=aS,bS=bS,Nsb=Nsb,asb=aSb,bsb=bSb)   
    return tempchi2


Data_points_SIDIS = SIDIS_Data_points_R()
# + SIDIS_Data_points_R()
...
par_array = np.array([4.99,1.08,1.96,9.1,4.3,3.96,0.11,-1.78,1.13,5.4,-25.9,6.14,19.4,-5.7,6.3,6.5,-16.7,7.4,19.9])
